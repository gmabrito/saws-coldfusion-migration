...
class EventRepository {
  /**
   * Write an event to the aquaanalytics.event_log table.
   */
  async logEvent(event) {
    ...
    await pool
      ...
      .query(
        `INSERT INTO aquaanalytics.event_log (event_id, event_type, payload, user_id, created_at)

      ...
      <header style={{
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: '24px' }}>
          ...
          <Link to="/" style={{ color: 'white', fontSize: '18px', fontWeight: 'bold', textDecoration: 'none' }}>
            SAWS - Fleet Management
          </Link>
          <nav style={{ display: 'flex', gap: '16px' }}>
            <Link to="/" style={{ color: 'rgba(255,255,255,0.9)', textDecoration: 'none' }}>Vehicles</Link>
            <Link to="/vehicles/new" style={{ color: 'rgba(255,255,255,0.9)', textDecoration: 'none' }}>Add Vehicle</Link>
          </nav>
        </div>
        {user && (

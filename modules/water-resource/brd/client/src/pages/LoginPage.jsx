  ...
  return (
    <div className="login-container">
      <div className="login-card">
        <h1>SAWS EZ Link</h1>
        <p className="login-subtitle">Water Resources - Aquifer Stats</p>
        ...
        <div style={{ marginTop: '24px', padding: '12px', background: '#f8f9fa', borderRadius: '4px', fontSize: '12px', color: '#6c757d' }}>
          ...
          admin / password - Water Resources Admin<br />
          operator / password - Data Operator<br />
          user / password - Public User (read-only)
        </div>
